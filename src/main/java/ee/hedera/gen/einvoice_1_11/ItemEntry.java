 ...
 *         &lt;element name="Description" type="{}LongTextType"/>
...
public class ItemEntry {
    ...
    protected List<ItemEntry.ItemDetailInfo> itemDetailInfo;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ItemEntry.ItemDetailInfo }
     * 
     * 
     */
    public List<ItemEntry.ItemDetailInfo> getItemDetailInfo() {
        if (itemDetailInfo == null) {
            itemDetailInfo = new ArrayList<ItemEntry.ItemDetailInfo>();
        }
