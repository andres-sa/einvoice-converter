...
public class AccountingRecord {
    ...
    protected List<AccountingRecord.JournalEntry> journalEntry;
     ...
     * {@link AccountingRecord.JournalEntry }
     * 
     * 
     */
    public List<AccountingRecord.JournalEntry> getJournalEntry() {
        if (journalEntry == null) {
            journalEntry = new ArrayList<AccountingRecord.JournalEntry>();
        }
